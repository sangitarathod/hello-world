...
if( !defined( 'SP_RHIMGS_VERSION' ) ) {
	define( 'SP_RHIMGS_VERSION', '3.0.4' ); // Version of plugin
}
...
function wpos_analytics_anl34_load() {
    ...
    $wpos_analytics =  wpos_anylc_init_module( array(
                            ...
                            'name'          => 'WP Responsive header image slider',
                            'slug'          => 'wp-responsive-header-image-slider',
                            'type'          => 'plugin',
                            'menu'          => 'edit.php?post_type=sp_responsiveslider',
                            'text_domain'   => 'responsive-header-image-slider',
                            'offers'        => array(
													'trial_premium' => array(
																'button'    => 'TRY FREE FOR 30 DAYS',
																'image'     => 'http://analytics.wponlinesupport.com/?anylc_img=34',
