										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a class="button button-primary" href="https://www.wponlinesupport.com/plugins-documentation/document-wp-responsive-header-image-slider/" target="_blank"><?php _e('Documentation', 'responsive-header-image-slider'); ?></a>
													<a class="button button-primary" href="http://demo.wponlinesupport.com/image-slider-demo/" target="_blank"><?php _e('Demo for Designs', 'sphis'); ?></a>
												</td>
											</tr>					
						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox" style="">
								...
								<div class="inside">										
									...
									<a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/wp-plugin/wp-slick-slider-and-image-carousel/" target="_blank">Go Premium </a>
									<p><a class="button button-primary wpos-button-full" href="http://demo.wponlinesupport.com/prodemo/pro-wp-slick-slider-and-carousel-demo/" target="_blank">View PRO Demo </a></p>
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
					...
					<div class="metabox-holder">
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox">
									...
									<div class="inside">										
										<p><?php _e('Enjoyed this plugin? You can help by rate this plugin', 'responsive-header-image-slider'); ?> <a href="https://wordpress.org/support/plugin/responsive-header-image-slider/reviews/" target="_blank">5 stars!</a></p>
									</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
