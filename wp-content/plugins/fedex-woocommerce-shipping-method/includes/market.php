...
<div class="box14 table-box-main">
    ...
    <span>
        <ul>
            ...
            <li> - <strong><?php echo __('Automatic label generation as soon as order is placed' , 'wf-shipping-fedex'); ?></strong></li>
            <li> - <strong><?php echo __('Bulk creation of shipments' , 'wf-shipping-fedex'); ?></strong></li>
            <li> - <strong><?php echo __('Handling of dangerous goods' , 'wf-shipping-fedex'); ?></strong></li>
            <li> - <strong><?php echo __('Generation of return label from customer’s “My Accounts” page.' , 'wf-shipping-fedex'); ?></strong></li>
            <li> - <strong><?php echo __('FedEx Smartpost' , 'wf-shipping-fedex'); ?></strong></li>
            <li> - <strong><?php echo __('Enable Pickup' , 'wf-shipping-fedex'); ?></strong></li>
            <li> - <strong><?php echo __('Handling of Freight shipment' , 'wf-shipping-fedex'); ?></strong></li>
