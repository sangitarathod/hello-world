...
class WCFMmp_Shipping_Zone {
  ...
  public static function get_method_label( $method_id ) {
    if ( 'flat_rate' == $method_id ) {
        return __( 'Flat Rate', 'wc-multivendor-marketplace' );
    } elseif ( 'local_pickup' == $method_id ) {
        return __( 'Local Pickup', 'wc-multivendor-marketplace' );
    } elseif( 'free_shipping' == $method_id ) {
        return __( 'Free Shipping', 'wc-multivendor-marketplace' );
    } else {
        return __( 'Custom Shipping', 'wc-multivendor-marketplace' );
    }
  }
