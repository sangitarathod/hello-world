...
class WCFMmp_Reviews {
  ...
  /**
	...
	public function show_star_rating( $store_rating = 0, $vendor_id = 0 ) {
		...
		if ( apply_filters( 'wcfm_is_pref_vendor_reviews', true ) && $store_rating ) { ?>
			<div class="star-rating wcfmmp-store-rating" title="<?php echo sprintf( __( 'Rated %s out of 5', 'wc-multivendor-marketplace' ), $store_rating ) ?>">
				<span style="width: <?php echo ( ( $store_rating/5 ) * 100 - 1 ); ?>%">
