...
class WCFMmp {
  ...
  public $wcfmmp_shipping_zone;
	...
	public function __construct($file) {
		...
		add_action( 'woocommerce_loaded', array( $this, 'init_wcfmmp' ) );
	}
	...
	function run_wcfmmp_installer() {
		...
		$wcfm_marketplace_tables = $wpdb->query( "SHOW tables like '{$wpdb->prefix}wcfm_marketplace_shipping_zone_locations'");
